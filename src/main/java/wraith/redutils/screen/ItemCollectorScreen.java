...
public class ItemCollectorScreen extends HandledScreen<ScreenHandler> {

    private static final Identifier TEXTURE = Utils.ID("textures/gui/item_collector.png");
    private boolean mouseClicked = false;
    private ArrayList<Button> buttons = new ArrayList<>();

    public ItemCollectorScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
